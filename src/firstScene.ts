...
preload() {
    ...
    //for recipe popup
    this.load.image("recipe", "assets/buttons/recipeButton.jpg")
}
create() {
    //ingrediet list
    ...
    // FOR POPUP
    this.recipeBtn = this.add.image(this.centerX, this.centerY, 'recipeButton');
    this.recipeBtn.setInteractive();

    // on popup button clicked

    this.recipeBtn.on('pointerup',(event: MouseEvent) => {
        // Jump to another scene...
        this.scene.start('spamRecipe');
    });
}
}